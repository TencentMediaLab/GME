...
### 鉴权信息
生成 AuthBuffer，用于相关功能的加密和鉴权，相关后台部署请查看[GME密钥文档](../GME%20Key%20Manual.md)。    
...
> 函数原型  
```
ITMGContext TMGPTT public int SpeechToText(String fileID,String language,String translateLanguage)
```
|参数     | 类型         |意义|
| ------------- |:-------------:|-------------|
| fileID    |String                     |语音文件 url|
