...
|QAVPTTERROR_PLAYER_PLAYER_NOT_START_ERR        |20485  |播放错误       ||确保文件存在，文件路径的合法性|
...
|QAVPTTERROR_S2T_PARAM_NULL                     |32778  |语音转文字错误     |流式语音转文本参数错误|检查代码中接口参数是否正确|
|QAVPTTERROR_S2T_AUTO_SPEECH_REC_ERROR          |32779  |语音转文字错误     |流式语音转文本翻译返回错误|检查代码是否有错误|
|QAVPTTERROR_ERR_VOICE_STREAMIN_RUNING_ERROR    |32780  |流式语音转文本错误     |流式语音转文本失败，但是录音成功了，上传也成功了。|检查代码是否有错误|