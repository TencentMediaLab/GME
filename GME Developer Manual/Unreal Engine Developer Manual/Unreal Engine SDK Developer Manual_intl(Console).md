This document describes how to access and debug GME APIs for Unreal Engine.
...
Event callbacks can be triggered by periodically calling the `Poll` API in `Tick`.
