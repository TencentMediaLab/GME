...
|参数	|类型	|意义 |
| ------- |---------|------|
| modelPath    	|string |3D音效资源文件路径，3D 音效模型文件请在此路径[下载](http://dldir1.qq.com/hudongzhibo/QCloud_TGP/GME/pubilc/GME_2.X_3d_model)，md5: d0b76aa64c46598788c2f35f5a8a8694，存放于本地中，并通过该参数将存放路径传递给 SDK|
