## Overview
Thank you for using Tencent Cloud Game Multimedia Engine SDK. This document provides a detailed description that makes it easy for PlayStation4 developers to debug and integrate the APIs of Game Multimedia Engine.
